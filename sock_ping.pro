...
;               20-Jan-2013, Zarro (ADNET) - Removed deprecated RETRY keyword
;               21-Feb-2013, Zarro (ADNET) - Added call to HAVE_NETWORK
;               29-Aug-2019, Zarro (ADNET) - Added call to SOCK_ERROR
;                9-Sep-2025, Zarro (ADNET) - Removed call to SOCK_ERROR
;                
