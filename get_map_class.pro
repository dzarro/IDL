...
function get_map_class,file,_ref_extra=extra,err=err,prepped=prepped
...
instrument=0b
for i=0,1 do begin
 det=get_fits_det(file,err=err,_extra=extra,instrument=instrument,prepped=prepped)
 ...
 if stregex(det,'EIT',/bool) then det='EIT'
